...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background pt-24 md:pt-28">
      {/* Background Elements */}
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="flex flex-col items-center -translate-y-10 md:-translate-y-16 will-change-transform"
        >
          ...
          <motion.h1 style={{ y: headlineY }} variants={itemVariants} className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter mb-8 leading-[1.1]">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-cyan-400 to-purple-500">
